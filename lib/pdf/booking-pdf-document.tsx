  ...
  return (
    <Document title={`${data.brandName} · ${title}`} author={data.brandName} subject={data.invoiceRef}>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={{ fontSize: 9.2, color: muted, marginBottom: 22 }}>{docIntro(data.docKind)}</Text>
        ...
        <Text style={[styles.h2, { marginTop: 22 }]}>Vehicle</Text>
        <View style={styles.row}>
        ...
        <Text style={[styles.h2, { marginTop: 22 }]}>Trip</Text>
        <View style={styles.grid2}>
          <View style={styles.col}>
            <Text style={{ color: muted, fontSize: 8, letterSpacing: 1.2, textTransform: 'uppercase' }}>Pickup</Text>
            <Text style={{ marginTop: 6, fontFamily: 'Helvetica-Bold' }}>{fmtWhen(data.pickupAt)}</Text>
            <Text style={{ marginTop: 4, color: muted }}>{data.pickupLocation}</Text>
          </View>
          <View style={styles.col}>
            <Text style={{ color: muted, fontSize: 8, letterSpacing: 1.2, textTransform: 'uppercase' }}>Return</Text>
            <Text style={{ marginTop: 6, fontFamily: 'Helvetica-Bold' }}>{fmtWhen(data.returnAt)}</Text>
            <Text style={{ marginTop: 4, color: muted }}>{data.returnLocation}</Text>
          </View>
        </View>
        ...
        <Text style={[styles.h2, { marginTop: 22 }]}>Pricing</Text>
        ...
        {data.securityDepositRupees != null && data.securityDepositRupees > 0 ? (
          <View style={[styles.row, { marginTop: 12, borderBottomWidth: 0 }]}>
        ...
        <View style={styles.foot}>
          <Text style={{ fontFamily: 'Helvetica-Bold', marginBottom: 6 }}>Support</Text>
          <Text>
            {data.supportPhone} · {data.supportEmail}
          </Text>
          <Text style={{ marginTop: 8, color: faint, fontSize: 7.5 }}>
          ...
          <Text style={{ marginTop: 6, fontSize: 7.5 }}>
            Terms & conditions:{' '}
