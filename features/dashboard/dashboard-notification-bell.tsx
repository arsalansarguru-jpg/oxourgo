      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className={cn(
              cardSurfaceBase,
              'absolute right-0 z-50 mt-2 w-[min(100vw-2rem,22rem)] overflow-hidden rounded-2xl border border-stroke bg-carbon/[0.92] p-0 shadow-[0_24px_80px_-32px_rgba(0,0,0,0.85)] backdrop-blur-2xl',
            )}
          >
