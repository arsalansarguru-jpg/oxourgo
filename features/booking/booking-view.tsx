...
export function BookingView({
  ...
  const [paymentMethod, setPaymentMethod] = useState<BookingPaymentMethod>('pay_at_pickup')
  ...
  const onSubmit = () => {
    ...
    if (paymentMethod === 'online_payment') {
      setFormError('Online payments coming soon — choose Pay at pickup to continue.')
      return
    }
        ...
        <div className="min-w-0 space-y-6">
          ...
          <motion.div layout className={cn(panel, cardSurfaceTransition, cardSurfaceHover)}>
            <PaymentMethodSelector
              ...
              onlineCheckoutAvailable={onlineCheckoutAvailable}
            />
</motion.div>
