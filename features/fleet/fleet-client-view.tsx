...
export function FleetClientView({ cars, pickup = '', from = '', to = '' }: FleetClientViewProps) {
  ...
  return (
    <Section className="pt-6 md:pt-10">
      ...
      {cars.length === 0 ? (
        <EmptyState
          icon={Search}
          title="Fleet is being updated"
          description="No cars are published yet. Add vehicles to the Supabase cars table to populate the fleet."
        />
      ) : filtered.length === 0 ? (
        <EmptyState
          icon={Search}
