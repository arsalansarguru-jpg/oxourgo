  ...
  return (
    <div className="w-full space-y-2">
      ...
      <select
        ...
        id={selectId}
        className={cn(
          'touch-manipulation min-h-12 w-full appearance-none rounded-xl border border-white/[0.12] bg-matte/[0.55] px-4 py-3 text-base tracking-[-0.01em] text-soft shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)] sm:min-h-11 sm:py-2 sm:text-sm',
