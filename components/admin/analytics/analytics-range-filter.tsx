        ...
        {PRESETS.map((p) => {
          ...
          return (
            <button
              ...
              className={cn(
                'rounded-full px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] transition-[background,color,box-shadow] duration-200',
                active
      ...
      >
        <label className="flex flex-col gap-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-muted">
          ...
          <input
            ...
            className="rounded-xl border border-white/[0.1] bg-matte/60 px-3 py-2 text-sm text-soft outline-none focus:border-electric/40"
          />
        </label>
        <label className="flex flex-col gap-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-muted">
          To
        ...
        <Button
          ...
          variant="secondary"
          size="sm"
          className={cn('min-h-10', range.preset === 'custom' && 'ring-1 ring-electric/35')}
        >
          Custom range
        </Button>
      </form>
