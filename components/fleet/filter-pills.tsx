      ...
      {ids.map((id) => {
        ...
        return (
          <button
            ...
            onClick={() => onToggle(id)}
            className={cn(
              'touch-manipulation inline-flex min-h-11 min-w-[2.75rem] items-center justify-center gap-1.5 rounded-full border px-3.5 py-2 text-xs font-semibold tracking-[-0.01em] transition-[border-color,background-color,color,transform,box-shadow] duration-300 active:scale-[0.97] sm:min-h-10 sm:py-1.5',
              isOn
