...
export const metadata: Metadata = {
  title: 'Payments',
  description: 'Payment history and rental charges for your Oxour Go bookings.',
}
...
export default async function PaymentsPage() {
  ...
  const [bookingsResult, events] = await Promise.all([
    listBookingsForUser(user.id),
    listPaymentEvents(user.id),
  ])
  return <CustomerPaymentsView bookings={unwrapListBookingsResult(bookingsResult)} events={events} />
}
