...
const skipClass =
  'sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[200] focus:rounded-md focus:bg-electric focus:px-4 focus:py-2.5 focus:text-white'
